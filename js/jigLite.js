;(function(document,window){
	...
	function Ziggle(jig,id,zig,preset,options,targetNode,delay){
		...
		q.data._parentX = parseInt( targetNode.parentNode.offsetLeft );
		q.data._parentY = parseInt( targetNode.parentNode.offsetTop );
		q.data._selfX = parseInt( targetNode.offsetLeft );
		q.data._selfY = parseInt( targetNode.offsetTop );
